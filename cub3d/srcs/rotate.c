...
/*   Updated: 2022/02/12 11:31:28 by sbouzidi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	rotate_right_left(t_datastock *datacube)
{
	...
	{
		datacube->raycast.dirx = datacube->raycast.dirx
			* cos(-datacube->raycast.rotspeed / 2) - datacube->raycast.diry
			* sin(-datacube->raycast.rotspeed / 2);
		datacube->raycast.diry = olddirx * sin(-datacube->raycast.rotspeed / 2)
			+ datacube->raycast.diry * cos(-datacube->raycast.rotspeed / 2);
		datacube->raycast.planx = datacube->raycast.planx
			* cos(-datacube->raycast.rotspeed / 2)
			- datacube->raycast.plany * sin(-datacube->raycast.rotspeed / 2);
		datacube->raycast.plany = oldplanx
			* sin(-datacube->raycast.rotspeed / 2)
...
void	left_rotate(t_datastock *datacube, double olddirx)
{
	...
	if (datacube->three_d.rotate_left == 1)
	{
		...
		datacube->raycast.diry = olddirx * sin(datacube->raycast.rotspeed / 2)
			+ datacube->raycast.diry * cos(datacube->raycast.rotspeed / 2);
		datacube->raycast.planx = datacube->raycast.planx
			* cos(datacube->raycast.rotspeed / 2) - datacube->raycast.plany
			* sin(datacube->raycast.rotspeed / 2);
		datacube->raycast.plany = oldplanex
			* sin(datacube->raycast.rotspeed / 2)
			+ datacube->raycast.plany * cos(datacube->raycast.rotspeed / 2);
	}
}
